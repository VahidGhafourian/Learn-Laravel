@component('admin.layouts.content', ['title' => 'ایجاد دسته'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item active" ><a href="{{ route('admin.categories.index') }}">لیست دسته بندی ها</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        @if(request('parent'))
                            ...
                            @endphp
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">دسته پدر</label>
