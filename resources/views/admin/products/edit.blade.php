@component('admin.layouts.content', ['title' => 'ویرایش محصول'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item active" ><a href="{{ route('admin.products.index') }}">لیست محصولات</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.products.update', $product->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="inventory" class="form-control" id="inputPassword3" placeholder="تعداد موجودی از این محصول را وارد کنید" value="{{ old('inventory', $product->inventory) }}">
                        </div>
